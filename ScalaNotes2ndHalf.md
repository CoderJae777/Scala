...
- [Dynamic Semantics (8B)](#dynamic-semantics-8b)
  - [Types of Dynamic Semantics](#types-of-dynamic-semantics)
    ...
    - [Big Step (Operational Semantics)](#big-step-operational-semantics)
      ...
      - [Example of Big Step with SIMP](#example-of-big-step-with-simp)
- [Static Semantics (9A)](#static-semantics-9a)
  - [SIMP and Type environments](#simp-and-type-environments)
  - [2 types of rules](#2-types-of-rules)
  - [Type Checking Expressions](#type-checking-expressions)
    - [Expression typing rules](#expression-typing-rules)
    - [Statement typing rules (checking statements)](#statement-typing-rules-checking-statements)
  - [Example](#example)
  - [Type Inference](#type-inference)
  - [Type Inference Rules for SIMP](#type-inference-rules-for-simp)
  - [Expression rules](#expression-rules)
  - [Statement rules](#statement-rules)
  - [Example](#example-1)
  - [Unification](#unification)
  - [Type Inference Formal Results](#type-inference-formal-results)
  - [Limitations of the Type Inference Algorithm](#limitations-of-the-type-inference-algorithm)
- [Static Semantics (Type Checking) (9B)](#static-semantics-type-checking-9b)
  - [Simply Typed Lambda Calculus](#simply-typed-lambda-calculus)
  - [Type Checking Rules](#type-checking-rules)
  - [Example for Type Checking](#example-for-type-checking)
  - [Simply Typed Calculus Type Checking Formal Properties](#simply-typed-calculus-type-checking-formal-properties)
  - [Simply Typed Lambda Calculus Limitation](#simply-typed-lambda-calculus-limitation)
- [Hindley-Milner Type System (HM)](#hindley-milner-type-system-hm)
  - [Key Features](#key-features)
  - [How it works (Intuition)](#how-it-works-intuition)
  - [Hindley Milner Syntax](#hindley-milner-syntax)
  - [Legend](#legend)
  - [Hindley Milner Type System - Type Checking Mode](#hindley-milner-type-system---type-checking-mode)
  - [Hindley Milner Type System Formal Properties](#hindley-milner-type-system-formal-properties)
  - [Hindley Milner Inference Mode](#hindley-milner-inference-mode)
  - [HMTS Example](#hmts-example)
  - [Walkthrough](#walkthrough)
- [Algorithm W](#algorithm-w)
  - [Algorithm W Rules](#algorithm-w-rules)
  - [Auxiliary Functions](#auxiliary-functions)
  - [Algorithm W - Examples & Walkthrough](#algorithm-w---examples--walkthrough)
